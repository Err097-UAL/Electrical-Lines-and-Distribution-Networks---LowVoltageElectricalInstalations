...
% the main comparison function (C5_CompareNetworks) and then generates a 
% detailed report comparing a Ring network and a Radial network based on 
% key metrics like voltage quality, reliability, and lifecycle cost.
% =========================================================================
...
% --- Reliability / Failure Impact Analysis ---
...
fprintf('Conclusion: Ring network maintains supply to all loads during a fault, while a radial\n');
fprintf('            network would cause a complete outage for downstream loads.\n');
