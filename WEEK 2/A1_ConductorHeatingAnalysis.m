function results = A1_ConductorHeatingAnalysis()
% =========================================================================
...
[I_max_AC, R_Tmat_AC, T_surface_at_max, P_dissipated_max] = A2_MaximumCurrent(R_20_AC, alpha, T_mat, T_ref, envParams, lineLength, r_inner_m, r_outer_m);
...
[time_ac, temp_cond_ac] = A6_TransientHeating(sim_current, [0 7200], envParams, R_20_AC, alpha, T_ref, lineLength, r_inner_m, r_outer_m, mass_cond, cp_cond);
